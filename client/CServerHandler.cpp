...
CServerHandler::CServerHandler()
	: state(EClientState::NONE), threadRunLocalServer(nullptr), shm(nullptr), threadConnectionToServer(nullptr), mx(new boost::recursive_mutex), client(nullptr), loadMode(0), campaignStateToSend(nullptr)
{
