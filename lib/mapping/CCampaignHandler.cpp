...
std::vector<JsonNode> CCampaignScenario::update782(std::vector<CGHeroInstance *> & heroes)
{
	static_assert(MINIMAL_SERIALIZATION_VERSION < 782, "No longer needed CCampaignScenario::update782");
